...
Please check [Wiki](https://github.com/wizadr/Raptoreum_SmartNode/wiki) for a detailed guide.
```bash
bash <(curl -s https://raw.githubusercontent.com/wizadr/Raptoreum_Smartnode/main/install.sh)
```
